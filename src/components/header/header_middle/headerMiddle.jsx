...
const HeaderMiddle = () => {
  ...
  }, [mobileMenu, shoppingCart, searchBar, loginForm, signUpForm, forgatPass]);
  return (
    <StyledHeaderMiddle>
      <Wrapper>
            ...
            <div className="headerRightInner">
              ...
              <Link to="/" className="loginIcon headerRightLink">
                <img
                  src={LoginIcon}
                  alt="log in icon"
                  className="headerRightImg loginIcon"
                  onClick={loginFormClick}
                />
              ...
              <Link to="/" className="wishListIcon headerRightLink">
                <div className="headerRightIcon">
                  <img
                    src={WishListIcon}
                    alt="wishlist icon"
                    className="headerRightImg wishlistIcon"
                  />
              ...
              <Link to="/" className="cartIcon headerRightLink">
                <div className="headerRightIcon">
                  <img
                    src={CartIcon}
                    alt="cart icon"
                    className="headerRightImg cartIcon"
      ...
      <div
        className={
          shoppingCart ? "openCartPopup cartPopup" : "closeCartPopup cartPopup"
        }
      >
        <div className="cartInner">
          ...
          <div className="cartPopupContent">
            <div className="cartHeader">
              ...
              <div className="cartGoalText">
                Buy{" "}
                <span className="amount">
                  <bdi>
                    <span className="currencySymbol">$</span>200.00
                  </bdi>
                </span>{" "}
              ...
              <table className="cartTable">
                <tfoot>
                  <tr>
                    ...
                    <td>
                      <span className="subTotalAmount">$0.00</span>
                    </td>
                  </tr>
                  <tr className="border">
      ...
      <div
        className={
          searchBar ? "popupSearch openSearchBar" : "popupSearch closeSearchBar"
        }
      >
      ...
      <div
        className={
          loginForm
            ? "popupLoginForm openLoginForm"
            : "popupLoginForm closeLoginForm"
        }
      >
      ...
      <div
        className={
          signUpForm
            ? "popupSignUpForm openSignUpForm"
            : "popupSignUpForm closeSignUpForm"
        }
      >
        <div className="overlay"></div>
              ...
              <form>
                ...
                <div className="formGroup check">
                  <label className="checkLabel">
                    <input type="checkbox" />
                    Yes, I agree with <Link to="/">Privacy Policy</Link> and
                    Terms of U signUp{" "}
                  </label>
                </div>
      ...
      <div
        className={
          forgatPass
            ? "popupForgetPass openForgetPass"
            : "popupForgetPass closeForgetPass"
        }
      >
        <div className="overlay"></div>
          ...
          <div className="inner">
            <div className="forgetPssHeader">
              ...
              <p className="description">
                ...
                link to create a new password via emailRemember now?
                <Link
                  to="/"
                  className="login"
                  onClick={() => {
            ...
            <div className="forgetPassBody">
              ...
              <div className="btn">
                <button type="submit" className="forgetPassSubmit">
                  <span>Log In</span>
                </button>
              </div>
            </div>
